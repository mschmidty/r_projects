...
###Notes on Mean Decrease
###Notes:
*needed to convert V4-6 to numberic, used lapply
*now getting error: "Error in na.fail.default(list(`as.factor(V24)` = c(2L, 2L, 2L, 1L, 2L, : missing values in object".  It is because I have NAs in my data set
